...
export function RoughFilters() {
  return (
    <svg className="absolute h-0 w-0 pointer-events-none" aria-hidden="true" style={{ position: 'absolute', width: 0, height: 0 }}>
      <defs>
...
function LineDecoration({ className }: Readonly<{ className?: string }>) {
  return <span aria-hidden="true" className={cn('block rounded-full bg-current', className)} />;
}

function DottedUnderlineDecoration({ className }: Readonly<{ className?: string }>) {
  return (
    <span
      aria-hidden="true"
      className={cn(
...
function DoubleUnderlineDecoration({ className }: Readonly<{ className?: string }>) {
  return (
    <svg className={className} viewBox="0 0 140 16" fill="none" preserveAspectRatio="none" aria-hidden="true">
      <path
...
function StrikethroughDecoration({ className }: Readonly<{ className?: string }>) {
  return (
    <svg className={className} viewBox="0 0 140 10" fill="none" preserveAspectRatio="none" aria-hidden="true">
      <path
...
function ArrowUnderlineDecoration({ className }: Readonly<{ className?: string }>) {
  return (
    <svg className={className} viewBox="0 0 150 18" fill="none" preserveAspectRatio="none" aria-hidden="true">
      <path
...
function BracketDecoration({ className }: Readonly<{ className?: string }>) {
  return (
    <svg className={className} viewBox="0 0 160 60" fill="none" preserveAspectRatio="none" aria-hidden="true">
      <path
...
function BoxDecoration({ className }: Readonly<{ className?: string }>) {
  return (
    <svg className={className} viewBox="0 0 200 64" fill="none" preserveAspectRatio="none" aria-hidden="true">
      <path
...
const annotationStyles = {
  wavy: {
    ...
    decorationClassName: 'pointer-events-none absolute bottom-[-0.4em] left-[-2%] h-[0.7em] w-[104%]',
    defaultColor: 'text-purple-400 dark:text-purple-300',
  },
  circle: {
    wrapper: 'relative inline-block px-1 whitespace-nowrap',
    Decoration: CircleDecoration,
    decorationClassName: 'pointer-events-none absolute inset-[-0.6em_-0.55em] h-[calc(100%+1.2em)] w-[calc(100%+1.1em)]',
    defaultColor: 'text-cyan-500 dark:text-cyan-300',
  },
  highlight: {
    wrapper: 'relative inline-block whitespace-nowrap',
    Decoration: HighlightDecoration,
    decorationClassName: 'pointer-events-none absolute inset-x-[-4%] bottom-[-0.08em] z-0 h-[1.15em] w-[108%]',
    defaultColor: 'text-amber-300/40 dark:text-amber-400/30',
  },
  underline: {
    wrapper: 'relative inline-block whitespace-nowrap',
    Decoration: UnderlineDecoration,
    decorationClassName: 'pointer-events-none absolute bottom-[-0.32em] left-[-1%] h-[0.5em] w-[102%]',
    defaultColor: 'text-rose-400 dark:text-rose-300',
  },
  line: {
    wrapper: 'relative inline-block whitespace-nowrap',
    Decoration: LineDecoration,
    decorationClassName: 'pointer-events-none absolute bottom-[-0.18em] left-[-1%] block h-[2px] w-[102%]',
    defaultColor: 'text-neutral-400 dark:text-neutral-500',
  },
  dottedUnderline: {
    wrapper: 'relative inline-block whitespace-nowrap',
    Decoration: DottedUnderlineDecoration,
    decorationClassName: 'pointer-events-none absolute bottom-[-0.35em] left-[-1%] block h-[0.55em] w-[102%]',
    defaultColor: 'text-neutral-400 dark:text-neutral-500',
  },
  doubleUnderline: {
    wrapper: 'relative inline-block whitespace-nowrap',
  ...
  strikethrough: {
    ...
    decorationClassName: 'pointer-events-none absolute top-1/2 left-[-1%] h-[0.5em] w-[102%] -translate-y-1/2',
    defaultColor: 'text-red-400',
  },
  crossOut: {
    wrapper: 'relative inline-block whitespace-nowrap',
    Decoration: CrossOutDecoration,
    decorationClassName: 'pointer-events-none absolute top-1/2 left-[-2%] h-[1.4em] w-[104%] -translate-y-1/2',
    defaultColor: 'text-red-400',
  },
  arrow: {
    wrapper: 'relative inline-block whitespace-nowrap',
    Decoration: ArrowUnderlineDecoration,
    decorationClassName: 'pointer-events-none absolute bottom-[-0.45em] left-[-1%] h-[0.8em] w-[106%]',
  ...
  bracket: {
    ...
    decorationClassName: 'pointer-events-none absolute inset-y-[-0.25em] left-[-0.15em] h-[calc(100%+0.5em)] w-[calc(100%+0.3em)]',
    defaultColor: 'text-amber-500 dark:text-amber-400',
  },
  box: {
    wrapper: 'relative inline-block px-[0.4em] whitespace-nowrap',
    Decoration: BoxDecoration,
    decorationClassName: 'pointer-events-none absolute inset-[-0.4em_-0.4em] h-[calc(100%+0.8em)] w-[calc(100%+0.8em)]',
...
export const AnnotatedText = forwardRef<HTMLSpanElement, AnnotatedTextProps>(
  ({ children, variant = 'wavy', color, className, style: customStyle }, ref) => {
    ...
    // Highlight decoration sits behind text to avoid obscuring glyphs
